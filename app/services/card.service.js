...
var CardService = (function () {
    ...
    CardService.prototype.getCards = function (options) {
    ...
    CardService.prototype.addOrUpdateCard = function (card) {
        if (card.id) {
    ...
    CardService.prototype.load = function () {
    ...
    CardService.prototype.save = function () {
